...
<section id="qellimi" class="section-head"><div><h2>Qëllimi i lëndës</h2><p>Lënda i aftëson studentët të kthejnë një nevojë reale të një biznesi shërbimesh në një aplikacion Next.js/PWA (Progressive Web App – aplikacion web progresiv) të përdorshëm. Studentët kalojnë nga intervista dhe skica te PRD-ja (Product Requirements Document – dokumenti i kërkesave të produktit), MVP-ja (Minimum Viable Product – produkti minimal i përdorshëm), implementimi, testimi dhe publikimi.</p><p><strong>RideShare</strong> është shembulli i përbashkët që ndërtohet në ushtrime. <strong>Projekti individual</strong> është një aplikacion tjetër për një biznes real familjar ose lokal të zgjedhur nga studenti.</p></div></section>
